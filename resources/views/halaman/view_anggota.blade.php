...
@section('isihalaman')
    <h3><center>Daftar Buku Perpustakaan Universitas Pembanguan Jaya</center></h3>
            ...
            @foreach ($anggota as $index=>$a)
                <tr>
                    ...
                    <td align="center">
                        ...
                        <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modalAnggotaEdit{{$bk->id_anggota}}"> 
                            Edit
                        </button>
                        
                         <!-- Awal Modal EDIT data Anggota -->
                        <div class="modal fade" id="modalAnggotaEdit{{$bk->id_anggota}}" tabindex="-1" role="dialog" aria-labelledby="modalAnggotaEditLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form name="formanggotaedit" id="formanggotaedit" action="/anggota/edit/{{ $bk->id_anggota}} " method="post" enctype="multipart/form-data">
                                            @csrf
                                            {{ method_field('PUT') }}
